...
curl -L https://github.com/alphagov/govuk-frontend/archive/v3.12.0.zip > govuk_frontend_source.zip
unzip -o govuk_frontend_source.zip -d govuk_frontend_source
rm -rf govuk_components
mkdir govuk_components
mv govuk_frontend_source/govuk-frontend-3.12.0/package/govuk/components/** govuk_components
